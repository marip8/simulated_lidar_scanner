...
/**
 * @brief A LidarPoint is a container to hold an intersection coordinate, the ray that was cast to obtain this
 * intersection, a flag to indicate if the point is a valid scene intersection, and the normal of the triangle of the
 * scene that was intersected by this ray
 */
